...
class CarouselViewModel: ObservableObject {
    ...
    func CreateCards(dateOfBirth: Date) {
        ...
        chineseAnimal = GetLocalInformation(index: index, fileName: "ChineseHoroscope.json")
        
        let nahualIndex = GetNahualIndex()
        nahual = GetNahual(nahualIndex: nahualIndex, fileName: "Nawal.json")
        generation = GetLocalInformation(index: dateOfBirth.GenerationIndex, fileName: "Generations.json")
    ...
    func GetLocalInformation(index: Int, fileName: String) -> LocalInformation {
        if let sampleRecordObj: [LocalInformation] = Bundle.main.decode(fileName){
    ...
    func GetNahual(nahualIndex: Int, fileName: String) -> Nahual {
        if let sampleRecordObj:[Nahual] = Bundle.main.decode(fileName) {
